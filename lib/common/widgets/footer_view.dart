...
//           }else {
//             Get.toNamed(route);
//             if((Get.currentRoute.contains(RouteHelper.offers) || Get.currentRoute.contains(RouteHelper.categories) || Get.currentRoute.contains(RouteHelper.allServiceScreen))) {

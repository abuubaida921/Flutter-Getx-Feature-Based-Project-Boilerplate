    ...
    return Focus(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          label: widget.isShowBorder == null ? Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
            ...
            if(widget.isRequired)
              Padding(padding: const EdgeInsets.symmetric(horizontal: 2),
                child: Text("*", style: ubuntuRegular.copyWith(
                    color: Theme.of(context).colorScheme.error
                ),),
              )
          ],) : null,
          labelStyle: ubuntuMedium.copyWith(fontSize: 20) ,
          ...
          contentPadding:  EdgeInsets.only(
            top: widget.isShowBorder != null && widget.isShowBorder!? Dimensions.paddingSizeDefault : 0.0,
